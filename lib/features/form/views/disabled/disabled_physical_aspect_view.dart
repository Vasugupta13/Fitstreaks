...
class DisabledPhysicalAspectView extends StatefulWidget {
  const DisabledPhysicalAspectView({super.key});

  @override
  State<DisabledPhysicalAspectView> createState() =>
      _DisabledPhysicalAspectViewState();
}

class _DisabledPhysicalAspectViewState
    extends State<DisabledPhysicalAspectView> {
