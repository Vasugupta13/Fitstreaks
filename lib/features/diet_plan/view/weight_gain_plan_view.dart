...
class WeightGainPlanView extends StatefulWidget {
  const WeightGainPlanView({super.key});

  @override
  State<WeightGainPlanView> createState() => _WeightGainPlanViewState();
}

class _WeightGainPlanViewState extends State<WeightGainPlanView>
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Expanded(
                        child: buildDietList(dietController.weightGainVegList,
                            AppColors.kGreenColor),
                      )
                    ],
                  ),
                  ...
                  Column(
                    children: [
                      ...
                      Expanded(
                        child: buildDietList(
                            dietController.weightGainNonVegList,
                            AppColors.kRedAccent),
                      )
                    ],
                  ),
